...
@section('titre')
    <title>Alertes - EB Connections</title>
@endsection
...
@section('contenu-header')
    <h1>
        Alertes
        <small>Gestion de vos alertes</small>
    </h1>
    <ol class="breadcrumb">
...
@section('contenu')
    <div class="box">
        ...
        <div class="box-body">
            <table id="alertes" class="table table-bordered table-striped display nowrap" style="width:100%">
                <thead>
                    <tr>
                        <th>Nom</th>
                        <th>Date</th>
