...
@section('titre')
    <title>Groupes - EB Connections</title>
@endsection
...
@section('contenu-header')
    <h1>
        Groupes
        <small>Gestion des groupes</small>
    </h1>
    <ol class="breadcrumb">
...
@section('contenu')
    <div class="box">
        ...
        <div class="box-body">
            <table id="groupes" class="table table-bordered table-striped display nowrap" style="width:100%">
                <thead>
                    <tr>
                        <th>Nom</th>
                        <th>Voir</th>
